...
function App() {
  ...
  // VALIDATION FOR ADD ITEM & HANDLE ADD ITEM ========================================================
  ...
  const handleAddDataSubmit = (event) => {
    ...
    // Validates if the other fields are empty
    if (!data.name) {
    ...
    // Puts the data into the invData state if the following conditions are fulfilled
  ...
  // ADD DATA TO THE NEW DATA STATE =========================================
  ...
  const deleteHandler = (removeID) => {
    ...
    if (!removeID) {
      setRemoveMsg('Please enter an Item ID');
    }
  }
    ...
    <>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path='/addPage' element={<AddItemPage addData={addData} addDataSubmit={handleAddDataSubmit} msg={msg} setMsg={setMsg} data={data} />} />
          <Route path='/updatePage' element={<UpdateItemPage setType={setType} updateHandle={updateHandle} setUpdateData={setUpdateData} updateMsg={updateMsg} setUpdateMsg={setUpdateMsg} updateID={updateID} setUpdateID={setUpdateID} type={type} updateData={updateData} />} />
